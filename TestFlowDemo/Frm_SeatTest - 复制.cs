...
namespace TestFlowDemo
{
    ...
    public partial class Frm_SeatTest : Form
    {
        ...
        private Dictionary<string, StepConfig> _stepConfig = new Dictionary<string, StepConfig>();
        ...
        public Frm_SeatTest()
        {
            ...
            dgv_StepInfoAndResult.DataSource = _stepList;
                ...
                foreach (var s in selectedSteps)
                {
                    if (s != null && !_stepLookup.ContainsKey(s.Name))
                    {
                        var info = new StepInfo
                        {
                            ...
                            Target = s.Target,
                            Command = s.Command,
                            //Expected = s.ExpectedResults != null ? $"{s.ExpectedResults.key}={s.ExpectedResults.value}" : "",
                            Status = "未开始",
                            ElapsedMs = 0,
                            Actual = ""
                        };
